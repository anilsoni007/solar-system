...
describe('Planets API Suite', function () {
  // Setup Mongoose connection before tests
  before(async function () {
    const mongoUri = process.env.MONGO_URI; // URI passed at runtime
    const mongoUsername = process.env.MONGO_USERNAME; // Username passed at runtime
